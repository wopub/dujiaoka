...
INSERT INTO `admin_menu` VALUES (26, 0, 23, 'Articles_Manage', 'fa-bookmark-o', NULL, '', 1, '2023-02-26 23:07:26', '2023-02-26 23:11:57');
INSERT INTO `admin_menu` VALUES (27, 26, 24, 'Articles', 'fa-list-alt', '/article', '', 1, '2023-02-26 23:09:54', '2023-02-26 23:10:15');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '卡密表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `goods`  (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '商品表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `goods_group`  (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '商品分类表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 51 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '订单表' ROW_FORMAT = Dynamic;
